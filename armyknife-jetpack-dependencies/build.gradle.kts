...
dependencies {
    ...
    "api"("androidx.work:work-rxjava2:2.0.1")
    ...
    "api"("androidx.navigation:navigation-common-ktx:2.1.0-alpha06")
    "api"("androidx.navigation:navigation-fragment-ktx:2.1.0-alpha06")
    "api"("androidx.navigation:navigation-runtime-ktx:2.1.0-alpha06")
    "api"("androidx.navigation:navigation-ui-ktx:2.1.0-alpha06")
    ...
    "api"("com.google.android.gms:play-services-measurement-api:17.0.0")
     ...
     * Firebase
     */
    "api"("com.google.firebase:firebase-analytics:17.0.0")
    ...
    "api"("com.google.firebase:firebase-ml-common:20.0.0")
    "api"("com.google.firebase:firebase-ml-model-interpreter:20.0.0")
    ...
    "api"("com.google.firebase:firebase-auth:18.0.0")
