...
dependencies {
    ...
    "api"("androidx.work:work-runtime:2.3.2")
    "api"("androidx.work:work-runtime-ktx:2.3.2")
    "api"("androidx.work:work-rxjava2:2.3.2")
    ...
    "api"("androidx.navigation:navigation-common-ktx:2.3.0-alpha02")
    ...
    "api"("androidx.paging:paging-rxjava2:2.1.1")
    ...
    "api"("androidx.room:room-guava:2.2.4")
...
//    "api"("com.google.android.gms:play-services-gass:18.3.0") // AdMob library.
    ...
    "api"("com.google.firebase:firebase-config:19.1.2")
}
