...
dependencies {
    ...
    "api"("androidx.fragment:fragment-ktx:1.2.3")
    ...
    "api"("androidx.navigation:navigation-common-ktx:2.3.0-alpha04")
    "api"("androidx.navigation:navigation-fragment-ktx:2.3.0-alpha04")
    "api"("androidx.navigation:navigation-runtime-ktx:2.3.0-alpha04")
    "api"("androidx.navigation:navigation-ui-ktx:2.3.0-alpha04")
    ...
    "api"("androidx.security:security-crypto:1.0.0-beta01")
    ...
    "api"("com.google.android.gms:play-services-measurement-api:17.2.3")
...
//    "api"("com.google.android.gms:play-services-gass:18.3.0") // AdMob library.
    ...
    "api"("com.google.firebase:firebase-iid:20.1.2")
